  ...
  <div class="tab-content">
    <div id="home" class="container tab-pane active" style="color:#082b2a;">
      ...
      <p style="text-indent: 50px;" align:"justify">The Department of Computer Science and Engineering at TCEK was
        started in the year 2008 with an intake of 60.
        Subsequently the intake is enhanced from 60 to 120 in the academic year 2010; The Department offers UG (B.Tech)
        degrees.
      ...
      <p style="text-indent: 50px;" align:"justify">To become a regional leader in providing the high quality education
        in the field of
        Computer Science and Engineering and nurturing the students to compete globally,
    ...
    <div id="menu1" class="container tab-pane fade" style="color:#082b2a;">
      ...
      <div class="row">
        <div class="col-sm-8">
          <p style="text-indent: 50px;" align:"justify"><b>Jilla Swathi,</b>Head, Department of CSE has completed her
            B.Tech
            with Computer Science and Engineering from JNTUH University, M.Tech with Computer Science from JNTUH
            University
            He is having more than 10 years of teaching experience.
            She is resource person for Infosys campus program;
    ...
    <div id="menu2" class="container tab-pane fade">
      ...
      <table class="table table-responsive">
        ...
        <tbody>
          ...
          <tr style="color:#082b2a;">
            <th scope="row">2</th>
            <td>SYED KHAJAPASHA</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>0802-170126-125051</td>
            <td>4 Years</td>
            <td><img src="images/CSE/khajapasha.jpeg" alt="description here" height="80" width="80" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">3</th>
            <td>ANJALI KOMUROJU</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>4513-190506-102113</td>
            <td>2 Years</td>
            <td><img src="images/CSE/anjali.jpeg" alt="description here" height="80" width="80" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">4</th>
            <td>MOHAMMAD ZIAUDDIN</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>5682-170203-164956</td>
            <td>4 Years</td>
            <td><img src="images/CSE/zaiuddin.jpeg" alt="description here" height="80" width="80" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">5</th>
            ...
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>7259-150409-113641</td>
            <td>10 Years</td>
            <td><img src="images/CSE/laxmi.jpeg" alt="description here" height="80" width="80" /></td>
          </tr>
          <!-- <tr style="color:#082b2a;">
            <th scope="row">2</th>
            <td>MEER SUBAN ALI SYED</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>58150405-163529</td>
            <td>10 Years</td>
            <td><img src="images/csefaculty/22.jpeg" alt="description here" height="120" width="100" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">3</th>
            <td>SUDHAKAR BADIKALA</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>8296-150409-091810</td>
            <td>10 Years </td>
            <td><img src="images/csefaculty/3.jpeg" alt="description here" height="120" width="100" /></td>
          </tr>
         
          <tr style="color:#082b2a;">
            <th scope="row">5</th>
            <td>VAMSHIVARDHAN SHANAGONDA</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>5054-150417-205058</td>
            <td>4 Years</td>
            <td><img src="images/csefaculty/5.jpeg" alt="description here" height="120" width="100" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">6</th>
            <td>MOHD ASEEM FEROZE</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>3136-160107-104243</td>
            <td>4 Years</td>
          ...
          <tr style="color:#082b2a;">
            <th scope="row">9</th>
            <td>NIMMALA NARESH</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>6845-180131-151354</td>
            <td>2 Years</td>
            <td><img src="images/csefaculty/9.jpeg" alt="description here" height="120" width="100" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">10</th>
            <td>KISHOR KUMAR REVELLI</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>7424-180131-172714</td>
            <td>2 Years</td>
            <td><img src="images/csefaculty/10.jpeg" alt="description here" height="120" width="100" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">11</th>
            <td>AMEENA SULTHANA</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>4172-180201-145641</td>
            <td>2 Years</td>
            <td><img src="images/csefaculty/11.jpg" alt="description here" height="120" width="100" /></td>
          </tr>
          ...
          <tr style="color:#082b2a;">
            ...
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>7575-200210-131406</td>
            <td>2 Years</td>
            <td><img src="images/csefaculty/13.jpg" alt="description here" height="120" width="100" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">14</th>
            <td>MAMINDLA THIRUMALA</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>7661-200227-132042</td>
            <td>2 Years</td>
            <td><img src="images/csefaculty/14.jpg" alt="description here" height="120" width="100" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">15</th>
            <td>SANDHYARANI ADAPA</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>7461-200227-134103</td>
            <td>2 Years</td>
            <td><img src="images/csefaculty/15.jpg" alt="description here" height="120" width="100" /></td>
          </tr>
          <tr style="color:#082b2a;">
            <th scope="row">16</th>
            <td>ANUSHA KOTTE</td>
            <td>Assistant Professor</td>
            <td>M.Tech</td>
            <td>6165-200227-141311</td>
            <td>2 Years</td>
            <td><img src="images/csefaculty/16.jpg" alt="description here" height="120" width="100" /></td>
          </tr> -->
        </tbody>
      </table>
    </div>
    ...
    <div id="menu4" class="container tab-pane fade">
      <div class="row">
        <h2 style="text-align:center; font-weight:bold; ;" class="bg-info ">CSE SYLLABUS</h2>
      </div>
      <h5>
    ...
    <div id="menu6" class="container tab-pane fade">
      <div class=row>
        <img src="images/CSE/CSE1.jpg" alt="" width="100%" height="250">
      </div>
      <div class="row">
        <div class="row">
          <div class="col-sm-6">
